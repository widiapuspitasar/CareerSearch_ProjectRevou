...
import Maincompany from "../../component/maincompany"; // Adjusted import path
import IconButton from "@mui/material/IconButton";
import FavoriteIcon from '@mui/icons-material/Favorite';  // Add import for FavoriteIcon
import FavoriteBorderIcon from '@mui/icons-material/FavoriteBorder';  // Add import for FavoriteBorderIcon
...
function Mainpagecompany() {
    ...
    return (
        <div>
            ...
            <div className="flex justify-start items-center mb-4 ml-6 mt-2"> {/* Modified this line */}
                <Link to="/postajob" className="text-blue-950">Post A Job</Link> {/* Modified this line */}
            </div>

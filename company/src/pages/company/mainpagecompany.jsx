    ...
    return (
        <div>
            ...
            <div className="flex justify-start items-center mb-4 ml-6 mt-2"> 
                <Link to="/postjob" className="bg-gray-300 text-black px-4 py-2 rounded-md">Post A Job</Link> 
            </div>
            <section className='container mx-auto p-8 bg-[#0F2C59] relative'>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Link to="/jobdetailcompany" className="rounded overflow-hidden shadow-lg bg-gray-100 flex p-3 relative">

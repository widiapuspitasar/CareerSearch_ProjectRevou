  ...
  return (
    <div>
      <section className="min-h-screen flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 p-8 bg-[#0F2C59] flex flex-col justify-center items-center lg:order-last">
        ...
        <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center items-center lg:order-first">
          <h2 className="text-2xl font-semibold mb-4"><img src="assets/logo.png" className="w-full h-auto mb-4" alt="Logo"/></h2>
          <form onSubmit={formik.handleSubmit} className="mb-8 flex flex-col items-center w-full max-w-md lg:order-last">
            ...
            <button type="submit" className="bg-[#0F2C59] text-white font-semibold px-4 py-2 rounded self-end" disabled={!formik.isValid}>Sign up</button>
          </form>

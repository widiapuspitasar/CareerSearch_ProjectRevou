        ...
        <section className='container mt-6 mx-auto p-8 bg-blue-900'>
          <div className="rounded overflow-hidden shadow-lg bg-gray-100 p-3 ">
            ...
            <div className='p-5 mt-4'>
                ...
                <button type="submit" className="bg-[#0F2C59] text-white font-semibold px-4 py-2 rounded self-end"><Link to="/editprofilepage">Edit Profile</Link></button>
                </div>
                <div className='flex items-center flex-col'>
                    <p className='text-2xl font-bold'>Lee Dohyun</p>

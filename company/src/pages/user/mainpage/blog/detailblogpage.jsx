      ...
      <div>
        ...
        <div className="flex flex-col lg:flex-row mt-3 mx-8">
          <section className='container mx-auto w-full lg:w-3/4 lg:pr-4'>
            <div className='mb-6'>
              <p className='font-extralight'> <Link to='/blogpage'>Blog</Link> / Tips & Trick / Tips Membuat CV ATS yang bakal dilirik sama perusahaan idaman! </p>
            </div>
            ...
            <div className='grid gap-5 m-5'>
                <div className="card bg-gray-200 p-4 rounded-lg shadow-md" style={{ maxWidth: '100%', height:'250px'}}>
                </div>
                <p>Halo sobat careersearch! jaman sekarang itu CV ATS  memudahkan proses screening. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem </p>
                <div className="card bg-gray-200 p-4 rounded-lg shadow-md" style={{ maxWidth: '100%', height:'250px'}}>
                </div>
                <p>Halo sobat careersearch! jaman sekarang itu CV ATS  memudahkan proses screening. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem </p>
                <div className="card bg-gray-200 p-4 rounded-lg shadow-md" style={{ maxWidth: '100%', height:'250px'}}>
            ...
            <div>
              ...
              <div className='flex gap-2 py-4'>
                ...
                <div className='kanan w-6/12'>
                  <div className="card bg-gray-200 p-4 rounded-lg shadow-md" style={{width: '100%', maxWidth: '500px', height: '100%'}}>
                  </div>
                </div>
              </div>
              <div className='flex gap-2 py-4'>

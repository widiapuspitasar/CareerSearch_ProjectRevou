      ...
      <section className="bg-[#0F2C59] text-white min-h-[90vh] column-12 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-start items-center">
          <div className="py-12 px-6 lg:px-20">
            <h1 className="text-4xl lg:text-5xl font-poppins tracking-wider leading-relaxed text-center lg:text-left">Your company page</h1>
        ...
        <div className="w-full lg:w-1/2 relative flex justify-center items-center">
          <img src="assets/man_working_table.png" alt="Man working table" className="w-full max-w-lg lg:w-[45rem] h-auto" />
        </div>
      </section>
          ...
          <div className="container mx-auto flex flex-wrap justify-center gap-16">
            ...
            <div className="flex items-center">
              <div className="flex flex-col">
                <p className="font-poppins mb-2">Company</p>
            ...
            <div className="flex items-center">
              <div className="flex flex-col">
                <p className="font-poppins mb-2">Join With Us</p>
                <div className="flex flex-col items-center">

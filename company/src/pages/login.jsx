      ...
      <div className="min-h-[100vh]">
        <section className=" min-h-[90vh] column-12 flex">
          ...
          <div className="w-1/2 p-8 flex flex-col justify-center items-center">
            <h2 className="text-2xl font-semibold mb-4"><img src="assets/logo.png" className="w-full h-auto"/></h2>
            <form className="mb-8 flex flex-col items-center w-full max-w-md">
              ...
              <button type="submit" className="bg-blue-950 text-white font-semibold px-4 py-2 rounded self-end"><Link to="/mainpage">Login</Link></button>
            </form>

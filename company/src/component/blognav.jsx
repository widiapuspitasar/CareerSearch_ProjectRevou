...
const Blognav = () => {
  ...
  return (
    <nav className="relative pt-4 px-4 flex justify-between items-center bg-white  w-full">
    {/* Logo */}
    ...
    <div className="hidden lg:flex lg:items-center ">
        <ul className="flex lg:flex lg:items-center lg:w-auto lg:space-x-6 lg:justify-end">

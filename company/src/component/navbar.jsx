    ...
    return (
        <nav className="relative px-4 lg:px-20 py-4 flex justify-between items-center bg-white">
            ...
            <div className="hidden lg:flex lg:gap-6 lg:items-center">
                <ul className="lg:flex lg:items-center lg:space-x-6 lg:justify-end">
                    <li><Link to="/aboutus" className="font-semibold text-lg text-blue-950 hover:text-blue-600">About Us</Link></li>
                    <li><Link to="/signyourcompany" className="font-semibold text-lg text-blue-950 hover:text-blue-600">Sign Your Company</Link></li>
                    <li><Link to="/login" className="font-semibold text-lg text-blue-950 hover:text-blue-600">Log In</Link></li>
                    <li><Link to="/signup" className="hidden lg:inline-block lg:mr-3 py-2 px-6 bg-sky-950 hover:bg-blue-600 text-sm text-white font-semibold rounded-md transition duration-200">Sign Up</Link></li>
                </ul>
            </div>
        </nav>
    );
